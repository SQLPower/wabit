...
public class WabitQuerySelectedItemTest extends AbstractWabitObjectTest {
    
    private WabitQuerySelectedItem selectedItem;
    ...
    protected void setUp() throws Exception {
        ...
        selectedItem = new WabitQuerySelectedItem(queryItem);
    }
