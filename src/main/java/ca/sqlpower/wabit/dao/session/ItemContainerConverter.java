...
public class ItemContainerConverter implements BidirectionalConverter<String, ItemContainer> {

	public ItemContainer convertToComplexType(String convertFrom)
	...
	public String convertToSimpleType(ItemContainer convertFrom,
