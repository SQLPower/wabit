...
public class WabitObjectComparator implements Comparator<WabitObject> {
    ...
    static {
        ...
        classOrderList.add(new HashSet<Class<? extends WabitObject>>(Collections.singleton(WabitOlapExclusion.class)));
        ...
        classOrderList.add(new HashSet<Class<? extends WabitObject>>(Collections.singleton(DateSelector.class)));
    }
