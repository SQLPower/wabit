...
/**
 * Retrieves text stored in a .properties file for swingui classes in Wabit.
 * This is done similarly to the Architect's way of handling messages across
 * multiple languages.
 */
public class Messages {
    private static final String BUNDLE_NAME = "ca.sqlpower.wabit.swingui.messages"; //$NON-NLS-1$
